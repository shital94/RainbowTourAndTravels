...
<h2 style="color:white; font-size:5em; text-align:center">hello</h2>


<!-- end of 2nd reusable part -->
<script src="admin/theme/js/jquery-2.2.3.min.js"></script>
<script src="admin/theme/js/bootstrap.js"></script>
<script src="admin/theme/js/dropdown.js"></script>
<!--login js-->
<script src="admin/theme/js/easyResponsiveTabs.js"></script>
<script src="admin/theme/js/jquery-1.6.3.min.js"></script>
<script src="admin/theme/js/jquery-1.9.1.min.js"></script>
<!--//login js-->
